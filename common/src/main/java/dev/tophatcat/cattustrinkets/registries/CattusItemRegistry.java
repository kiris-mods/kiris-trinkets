...
public class CattusItemRegistry {

    public static void init() {
        CattusTrinketsCommon.LOG.info("Registering items...");
    }

    public static final Supplier<Item> ENDER_DUST = RegistryTools.registerItem(
        "ender_dust", () -> new Item(new Item.Properties()));
}
