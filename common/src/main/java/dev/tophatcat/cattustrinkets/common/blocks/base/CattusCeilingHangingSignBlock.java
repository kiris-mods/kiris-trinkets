...
public class CattusCeilingHangingSignBlock extends CeilingHangingSignBlock {

    public CattusCeilingHangingSignBlock(WoodType woodType, Properties properties) {
