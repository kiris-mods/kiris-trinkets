...
public class CattusButtonBlock extends ButtonBlock {

    public CattusButtonBlock(BlockSetType woodType, int ticksToStayPressed, Properties properties) {
        super(woodType, ticksToStayPressed, properties);
    }
}
